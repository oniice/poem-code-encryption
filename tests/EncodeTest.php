...
class EncodeTest extends TestCase
{
     ...
     * @covers ::encode
     */
    public function testStringIsEncodedCorrectlyOne($poem, $indicators, $message, $encoded): void
    {
        $encoder = new Encode();

        $grid = $encoder->encode($poem, $indicators, $message);

        $this->assertEquals($grid->getEncodedMessage(), $encoded);
    }
